...
# establishing the path of the folder for uploading the file
UPLOAD_FOLDER = os.path.abspath("app/static/attachments")

# writing backend of a login page
...
# writing backend of a log out page
...
# writing backend of an address form
...
# writing backend of an order tracking page
...
# writing backend of a product catalogue page
...
# writing the backend of the path to download the file
@api.route("/download/<path:filename>")
def download(filename):
    return send_file(os.path.join(UPLOAD_FOLDER, filename), as_attachment=True)

# writing the backend of a search bar
...
# creating the backend of no result page
