...
# establishing a blueprint for frontend
views = Blueprint('views', __name__, url_prefix="/")

# creating the frontend of login page
@views.route('/')
@cross_origin()
def login():
    try:
...
# creating the frontend of dashboard
...
# creating the frontend of profiles page
@views.route('/profile')
@cross_origin()
def profile():
    try:
...
#creating the frontend of orders page
@views.route('/order')
@cross_origin()
def order():
    try:
...
# creating the frontend of help page
@views.route("/help")
@cross_origin()
def help_page():
    try:
...
# creating the frontend of message page for operators
@views.route("/editor")
@cross_origin()
def editor():
    try:
